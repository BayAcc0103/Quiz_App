...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20251103123259_AddRoomAnswerEntity")]
    partial class AddRoomAnswerEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAELYuIa/x5FmZDSjenZ8QfJSMtM3DvYhLYhZ9WmWh+3EvZorv2Pg9INk1cxRz9zM7rQ==",
                            Phone = "0123456789",
                            Role = "Admin"
                        });
                });
