...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20251112144819_AddStudentQuizzesForRoomTable")]
    partial class AddStudentQuizzesForRoomTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.StudentQuizQuestion", b =>
                {
                    ...
                    b.HasIndex("StudentQuizForRoomId");
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEL2Mk210XYkVWE8bSdXIKej1HZjjjeo7oN9kV00glg3sLXCE80Ur/fxs1prMiQjP0Q==",
                            Phone = "0123456789",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.StudentQuizQuestion", b =>
                {
                    ...
                    b.HasOne("BlazingQuiz.Api.Data.Entities.StudentQuizForRoom", null)
                        .WithMany("StudentQuizQuestions")
