...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20251025161703_CombineRatingAndCommentIntoQuizFeedback")]
    partial class CombineRatingAndCommentIntoQuizFeedback
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEHBJQi0CK2q072XNVwU0Mvl67GcN+ffUo1LzuSNJIks3Fk6qdsgwGNy2S05B8Hl4yA==",
                            Phone = "0123456789",
                            Role = "Admin"
                        });
                });
