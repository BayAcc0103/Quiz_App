...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20251102162439_AddIsReadyToRoomParticipant")]
    partial class AddIsReadyToRoomParticipant
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEL1u8zPCjyrYSpIAycer9OSzaQ9BLLfqgzr/DDXFUHxEDBFJ7851BZ89vlWR/39Vng==",
                            Phone = "0123456789",
                            Role = "Admin"
                        });
                });
